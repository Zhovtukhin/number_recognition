# -*- coding: utf-8 -*-
"""TrainDigitRecognizer_SVHM_aug.ipynb
...
trainSVHM = datasets.SVHN('../data/SVHN', split='train', download=True, transform=train_test_transforms_SVHM)
testSVHM = datasets.SVHN('../data/SVHN', split='test', download=False, transform=train_test_transforms_SVHM)
        ...
        for color in [70, 100, 120, 160, 200, 220, 255]:
            for thik in [0, 1, 2]:
                for line in [cv2.FILLED, cv2.LINE_4, cv2.LINE_8, cv2.LINE_AA]:
                    ...
                    test_aug.append((transforms.Normalize((0.3977, ), (0.2329, ))(transforms.ToTensor()(img)), digit))
print(len(test_aug))
...
torch.save(best_model.state_dict(), '../models/SVHM_aug_model.pth')
